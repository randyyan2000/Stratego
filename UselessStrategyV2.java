...
public class UselessStrategyV2 implements Strategy
{
  private Player player;
  
  public UselessStrategyV2() //this exists
  {}
    ...
    for (int i = 0; i < allMoves.size(); i++)
    {
      if (player.getPiece(allMoves.get(i).getTo()) != null)
      {
        ...
        if (player.getPiece(allMoves.get(i).getFrom()).canCapture(player.getPiece(allMoves.get(i).getTo())) < 0)
        {
          ...
          {
            if (player.getPiece(allMoves.get(j).getTo()) == null)
            {
              attack.add(new Move(allMoves.get(j).getFrom(), allMoves.get(j).getTo()));
            }
          }
        }
      }
    ...
    if (attack.size() == 0)
    {
      for (int i = 0; i < allMoves.size(); i++)
      {
        if (player.getPiece(allMoves.get(i).getTo()) != null)
        {
          if (player.getPiece(allMoves.get(i).getFrom()).canCapture(player.getPiece(allMoves.get(i).getTo())) == 0)
            attack.add(new Move(allMoves.get(i).getFrom(), allMoves.get(i).getTo()));
          if (player.getPiece(allMoves.get(i).getFrom()).getRank() == 2 
                && player.getPiece(allMoves.get(i).getTo()).hasRevealed() == false
             && player.getPiece(allMoves.get(i).getTo()).hasMoved() == true)
          {
            attack.add(new Move(allMoves.get(i).getFrom(), allMoves.get(i).getTo()));
          }
          if (player.getPiece(allMoves.get(i).getFrom()).getRank() == 4 
                && player.getPiece(allMoves.get(i).getTo()).hasRevealed() == false
             && player.getPiece(allMoves.get(i).getTo()).hasMoved() == true)
          {
            attack.add(new Move(allMoves.get(i).getFrom(), allMoves.get(i).getTo()));
          }
          if (player.getPiece(allMoves.get(i).getTo()).hasRevealed() == false 
                && player.getPiece(allMoves.get(i).getTo()).hasMoved() == true
             && player.getPiece(allMoves.get(i).getFrom()).getRank() != 9
             && player.getPiece(allMoves.get(i).getFrom()).getRank() != 10)
            attack.add(new Move(allMoves.get(i).getFrom(), allMoves.get(i).getTo()));
        }
      }
    }
